...
const etiquetas2 = ["Transporte", "Servicios", "Alimento", "Deporte", "Alquiler"];
...
const datosEgresos = {
    label: "Ingresos",
    data: [1500, 400, 2000, 7000, 750], //la data es un arreglo que debe tener la misma cantidad de valores que la cantidad de etiquetas
    //ahora deberia haber tantos background colors como datos
    backgroundColor: [
